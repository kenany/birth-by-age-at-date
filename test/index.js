...
test('throws TypeError when date is not a Date', (t) => {
  t.plan(5);
...
test('returns TypeError when currentDate is not a Date', (t) => {
  t.plan(4);
...
test('works', (t) => {
  ...
  t.deepEquals(birth(50, new Date(2013, 3, 17), now), {
    lowerYear: 1962,
    upperYear: 1963,
    lowerAge: 51,
  });

  t.deepEquals(birth(50, new Date(2013, 0, 15), now), {
    lowerYear: 1962,
    upperYear: 1963,
    lowerAge: 51,
    upperAge: 52,
  ...
  t.deepEquals(birth(50, new Date(2013, 10, 5), now), {
    lowerYear: 1962,
    upperYear: 1963,
    lowerAge: 50,
    upperAge: 51,
